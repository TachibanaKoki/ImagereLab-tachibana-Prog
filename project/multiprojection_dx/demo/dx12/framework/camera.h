...
namespace Framework
{
	...
	public:
		...
		virtual bool		HandleWindowsMessage(UINT message, WPARAM wParam, LPARAM lParam);
	...
	public:
		...
		void				SetProjection(float vFOV, float aspect, float zNear, float zFar);
		void				SetReverseProjection(float vFOV, float aspect, float zNear);
	...
	public:
		...
		virtual bool		HandleWindowsMessage(UINT message, WPARAM wParam, LPARAM lParam) override;
