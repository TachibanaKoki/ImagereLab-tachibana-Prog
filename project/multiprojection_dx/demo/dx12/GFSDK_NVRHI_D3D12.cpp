...
namespace NVRHI
{
    ...
    public:
        ...
        virtual ~ConstantBuffer()
        {
            ...
            DEBUG_PRINTF(CB_STATISTICS, "ConstantBuffer %s, %d bytes, %d writes, %d identical writes, %d refreshes, %d evictions, %d cached refs\n",
    ...
    TextureHandle RendererInterfaceD3D12::getHandleForTexture(ID3D12Resource * pResource, Format::Enum formatOverride)
    {
	...
	void RendererInterfaceD3D12::requireTextureState(TextureHandle texture, uint32_t subresource, uint32_t state, bool& anyUavBarrier)
	{
	...
	void RendererInterfaceD3D12::resolveTexture(TextureHandle dst, TextureHandle src, Format::Enum format, uint32_t dstSubres, uint32_t srcSubres)
	{
