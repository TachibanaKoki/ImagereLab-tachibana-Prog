...
namespace NVRHI
{
  ...
  public:
	...
	TextureHandle getHandleForTexture(ID3D11Resource* resource, Format::Enum formatOverride = Format::UNKNOWN) { return getHandleForTextureInternal(resource, nullptr, formatOverride); }
