...
namespace Framework
{
	...
	public:
		...
		std::vector<double>	m_msAvg;		// Average milliseconds since previous marker, for each marker + 1 (whole frame time)
		...
		std::vector<double>					m_msSum;					// Summed timings waiting for average
		int									m_markerCount;
